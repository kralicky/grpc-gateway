...
gulp.task('server', shell.task([
  'go build -o bin/example-server github.com/kralicky/grpc-gateway/v2/examples/pkg/cmd/example-grpc-server',
]));

gulp.task('gateway', shell.task([
  'go build -o bin/example-gw github.com/kralicky/grpc-gateway/v2/examples/pkg/cmd/example-gateway-server',
]));
